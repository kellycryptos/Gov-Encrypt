        ...
        <section className="relative pt-20 pb-20 lg:pt-32 lg:pb-32 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex items-center gap-8 pt-4">
                        <div className="flex -space-x-3">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="w-10 h-10 rounded-full bg-slate-800 border-2 border-[#020617] flex items-center justify-center text-xs font-bold text-slate-500">
                                    U{i}
                                </div>
                            ))}
                        </div>
                ...
                <div className="relative">
                    <div className="relative z-10 glass-card p-1 rounded-2xl shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-700">
                        <div className="bg-[#0f172a]/80 backdrop-blur-md rounded-xl p-6 border border-white/5 space-y-6">
                            {/* Fake UI Elements */}
                            ...
                            <div className="space-y-4">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="p-4 rounded-lg bg-white/5 border border-white/5 flex items-center justify-between">
                    ...
                    <div className="absolute -top-10 -right-10 w-40 h-40 bg-violet-500/30 rounded-full blur-3xl" />
